...
function displayDayFor(date = new Date()) {
...
function displayDayStartForDateInput(yyyyMmDd) {
...
function cutoffForFilter(filter, now = new Date()) {
...
function formatRelative(lastActive, now = new Date()) {
